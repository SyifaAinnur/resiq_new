...
<!-- Mirrored from techydevs.com/demos/themes/html/trizen-demo/trizen/cruises.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 24 Aug 2021 11:42:40 GMT -->
<head>
    ...
    <link rel="stylesheet" href="assets/assets-landing/css/bootstrap-select.min.css">
    <link rel="stylesheet" href="assets/assets-landing/css/line-awesome.css">
    <link rel="stylesheet" href="assets/assets-landing/css/owl.carousel.min.css">
    <link rel="stylesheet" href="assets/assets-landing/css/owl.theme.default.min.css">
    <link rel="stylesheet" href="assets/assets-landing/css/jquery.fancybox.min.css">
    <link rel="stylesheet" href="assets/assets-landing/css/daterangepicker.css">
    <link rel="stylesheet" href="assets/assets-landing/css/animate.min.css">
    <link rel="stylesheet" href="assets/assets-landing/css/animated-headline.css">
    <link rel="stylesheet" href="assets/assets-landing/css/jquery-ui.css">
    <link rel="stylesheet" href="assets/assets-landing/css/flag-icon.min.css">
    <link rel="stylesheet" href="assets/assets-landing/css/style.css">
</head>
<body>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="menu-wrapper">
                        ...
                        <div class="logo">
                            <a href="index.php"><h1 style="margin-left: 30px;">Resiq.id</h1></a>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <ul class="dropdown-menu-item">
                                            <li><a href="tour-fullwidth.html">Member Pemasok</a></li>
                                            <li><a href="tour-grid.html">Konsumen</a></li>
                                            <li><a href="tour-list.html">Mitra Daur</a></li>
                                        </ul>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        ...
                                        <ul class="dropdown-menu-item">
                                            <li><a href="add-hotel.html">Rantai Pasok Sampah </a></li>
                                            <li><a href="add-flight.html">Pemilihan Sampah </a></li>
                                            <li><a href="add-tour.html">Biopori dan Kompos </a></li>
                                        </ul>
                                    </li>
                                    <li>
                                        ...
                                        <ul class="dropdown-menu-item">
                                            ...
                                            <li><a href="pengepul.php">Pemulung(IPI) </a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </nav>
                ...
                <div class="col-lg-6">
                    <div class="breadcrumb-content">
                        <div class="section-heading">
                            <h2 class="sec__title text-white">Kerajinan</h2>
                        </div>
            ...
            <div class="col-lg-12">
                <div class="filter-wrap margin-bottom-30px">
                    <div class="filter-top d-flex align-items-center justify-content-between pb-4">
                        <div>
                            <h3 class="title font-size-24">Produk</h3>
                        </div>
                    </div><!-- end filter-top -->
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 responsive-column">
                <div class="card-item car-card mb-0">
                    <div class="card-img">
                        <a href="car-single.html" class="d-block">
                            <img src="assets/assets-landing/images/produk/kerajinan6.jpg" width="30%" alt="">
                        </a>
                        <div class="add-to-wishlist icon-element" data-toggle="tooltip" data-placement="top" title="Save for later">
                            <i class="la la-heart-o"></i>
                        </div>
            ...
            <div class="col-lg-4 responsive-column">
                <div class="card-item car-card mb-0">
                    <div class="card-img">
                        <a href="car-single.html" class="d-block">
                            <img src="assets/assets-landing/images/produk/kerajinan3.png" alt="car-img">
                        </a>
                        <div class="add-to-wishlist icon-element" data-toggle="tooltip" data-placement="top" title="Save for later">
                            <i class="la la-heart-o"></i>
                        </div>
            ...
            <div class="col-lg-4 responsive-column">
                <div class="card-item cruise--card">
                    <div class="card-img">
                        <a href="car-single.html" class="d-block">
                            <img src="assets/assets-landing/images/produk/kerajinan4.jpg" width="50px" alt="car-img">
                        </a>
                        <span class="badge">Bestseller</span>
                        <div class="add-to-wishlist icon-element" data-toggle="tooltip" data-placement="top" title="Save for later">
                            <i class="la la-heart-o"></i>
            ...
            <div class="col-lg-4 responsive-column">
                <div class="card-item cruise--card">
                    <div class="card-img">
                        <a href="car-single.html" class="d-block">
                            <img src="assets/assets-landing/images/produk/kerajinan2.jpg" width="100px" alt="car-img">
                        </a>
                        <div class="add-to-wishlist icon-element" data-toggle="tooltip" data-placement="top" title="Save for later">
                            <i class="la la-heart-o"></i>
                        </div>
            ...
            <div class="col-lg-4 responsive-column">
                <div class="card-item cruise--card">
                    <div class="card-img">
                        <a href="car-single.html" class="d-block">
                            <img src="assets/assets-landing/images/produk/kerajinan7.jpg" width="100px" alt="">
                        </a>
                        <div class="add-to-wishlist icon-element" data-toggle="tooltip" data-placement="top" title="Save for later">
                            <i class="la la-heart-o"></i>
                        </div>
...
<!-- Template JS Files -->
<script src="assets/assets-landing/js/jquery-3.4.1.min.js"></script>
<script src="assets/assets-landing/js/jquery-ui.js"></script>
<script src="assets/assets-landing/js/popper.min.js"></script>
<script src="assets/assets-landing/js/bootstrap.min.js"></script>
<script src="assets/assets-landing/js/bootstrap-select.min.js"></script>
<script src="assets/assets-landing/js/moment.min.js"></script>
<script src="assets/assets-landing/js/daterangepicker.js"></script>
<script src="assets/assets-landing/js/owl.carousel.min.js"></script>
<script src="assets/assets-landing/js/jquery.fancybox.min.js"></script>
<script src="assets/assets-landing/js/jquery.countTo.min.js"></script>
<script src="assets/assets-landing/js/animated-headline.js"></script>
<script src="assets/assets-landing/js/jquery.ripples-min.js"></script>
<script src="assets/assets-landing/js/quantity-input.js"></script>
<script src="assets/assets-landing/js/copy-text-script.js"></script>
<script src="assets/assets-landing/js/navbar-sticky.js"></script>
<script src="assets/assets-landing/js/main.js"></script>
</body>

<!-- Mirrored from techydevs.com/demos/themes/html/trizen-demo/trizen/tour-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 24 Aug 2021 11:42:37 GMT -->
</html>