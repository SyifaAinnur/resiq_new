...
<body onload="startTime()">
    ...
    <script src="/assets/admin/js/chart/chartist/chartist.js"></script>
    <script src="/assets/admin/js/chart/chartist/chartist-plugin-tooltip.js"></script>
    <script src="/assets/admin/js/chart/knob/knob.min.js"></script>
    <script src="/assets/admin/js/chart/knob/knob-chart.js"></script>
    ...
    <script src="/assets/admin/js/datepicker/date-picker/datepicker.js"></script>
    <script src="/assets/admin/js/datepicker/date-picker/datepicker.en.js"></script>
    <script src="/assets/admin/js/datepicker/date-picker/datepicker.custom.js"></script>
