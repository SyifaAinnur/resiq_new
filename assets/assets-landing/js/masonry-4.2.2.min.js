!function(t,
    e) {
        ...
        require("jquery")):t.jQueryBridget=e(t,
        t.jQuery)
    }
    (window,
    function(t,
    ...
    function() {
        ...
        ,
        e.emitEvent=function(t,
        e) {
            var i=this._events&&this._events[t];
            if(i&&i.length) {
                i=i.slice(0), e=e||[];
                for(var n=this._onceEvents&&this._onceEvents[t], o=0;
                o<i.length;
                o++) {
                    var r=i[o], s=n&&n[r];
    ...
    function() {
        ...
        function r(e) {
            if(o(), "string"==typeof e&&(e=document.querySelector(e)), e&&"object"==typeof e&&e.nodeType) {
                ...
                for(var d=a.isBorderBox="border-box"==r.boxSizing, l=0;
                u>l;
                l++) {
    ...
    e) {
        ...
        require("desandro-matches-selector")):t.fizzyUIUtils=e(t,
        t.matchesSelector)
    }
    (window,
    function(t,
    e) {
        ...
        ,
        i.removeFrom=function(t,
        e) {
            var i=t.indexOf(e);
            -1!=i&&t.splice(i, 1)
        }
        ,
        i.getParent=function(t,
        i) {
            for(;
        ...
        ,
        i.filterFindElements=function(t,
        n) {
            t=i.makeArray(t);
            var o=[];
            return t.forEach(function(t) {
                if(t instanceof HTMLElement) {
                    ...
                    e(t, n)&&o.push(t);
                    for(var i=t.querySelectorAll(n), r=0;
                    r<i.length;
                    r++)o.push(i[r])
                }
            }
    ...
    e) {
        ...
        [s],
        u= {
            transform: a, transition: s, transitionDuration: s+"Duration", transitionProperty: s+"Property", transitionDelay: s+"Delay"
        }
        ,
        ...
        d.enableTransition=function() {
            if(!this.isTransitioning) {
                ...
                t="number"==typeof t?t+"ms": t, this.css( {
                    transitionProperty: l, transitionDuration: t, transitionDelay: this.staggerDelay||0
                }
                ),
                this.element.addEventListener(h,
                this,
                !1)
            }
        }
    ...
    o) {
        ...
        f._itemize=function(t) {
            for(var e=this._filterFindItemElements(t), i=this.constructor.Item, n=[], o=0;
            o<e.length;
            o++) {
        ...
        ,
        f._getMeasurement=function(t,
        e) {
            var n, o=this.options[t];
            o?("string"==typeof o?n=this.element.querySelector(o): o instanceof HTMLElement&&(n=o), this[t]=n?i(n)[e]: o): this[t]=0
        }
        ,
        f.layoutItems=function(t,
        e) {
        ...
        f._setContainerMeasure=function(t,
        e) {
            if(void 0!==t) {
                var i=this.size;
        ...
        ,
        f._emitCompleteOnItems=function(t,
        e) {
            function i() {
    ...
    e) {
        ...
        n._getTopColGroup=function(t) {
            ...
            i>n;
            n++)e[n]=this._getColGroupY(n, t);
            return e
        }
        ,
        n._getColGroupY=function(t,
        e) {
        ...
        ,
        n._getHorizontalColPosition=function(t,
        e) {
        ...
        n._manageStamp=function(t) {
            ...
            for(var u=this._getOption("originTop"), d=(u?n.top: n.bottom)+i.outerHeight, l=a;
            h>=l;
            l++)this.colYs[l]=Math.max(d, this.colYs[l])
        }
        ,
