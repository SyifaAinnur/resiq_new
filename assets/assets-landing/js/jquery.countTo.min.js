!function(t) {
	...
	e.prototype.dataOptions=function() {
		var t= {
			from: this.$element.data("from"), to: this.$element.data("to"), speed: this.$element.data("speed"), refreshInterval: this.$element.data("refresh-interval"), decimals: this.$element.data("decimals")
		}
		,
		e=Object.keys(t);
		for(var o in e) {
	...
	t.fn.countTo=function(o) {
		return this.each(function() {
			var i=t(this), s=i.data("countTo"), n="object"==typeof o?o:  {}, r="string"==typeof o?o: "start";
