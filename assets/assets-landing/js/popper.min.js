(function(e,
    ...
    function() {
        ...
        o) {
            ...
            return(p&&!i?o.contains(l):o===l&&'BODY'!==l.nodeName)&&(b=f(b,
            o)),
            b
        }
        function w(e) {
        ...
        function k() {
            if(!this.state.isDestroyed) {
                ...
                ;
                e.offsets.reference=L(this.state,
                this.popper,
                this.reference,
                this.options.positionFixed),
                e.placement=O(this.options.placement,
                e.offsets.reference,
                this.popper,
                this.reference,
                ...
                e.offsets.popper=D(this.popper,
                e.offsets.reference,
                e.placement),
        ...
        ie=0;
        ie<oe.length;
        ie+=1)if(te&&0<=navigator.userAgent.indexOf(oe[ie])) {
            ne=1;
            break
        }
            ...
            placement: 'bottom', positionFixed: !1, eventsEnabled: !0, removeOnDestroy: !1, onCreate: function() {}, onUpdate: function() {}, modifiers: {
                ...
                flip: {
                    order: 600, enabled: !0, fn: function(e, t) {
                        ...
                        switch(t.behavior) {
                            case ge.FLIP: p=[n, i];
                            break;
                            case ge.CLOCKWISE: p=G(n);
                            break;
                            case ge.COUNTERCLOCKWISE: p=G(n, !0);
                            break;
                ...
                computeStyle: {
                    order: 850, enabled: !0, fn: function(e, t) {
                        ...
                        a&&b)m[b]='translate3d('+s+'px, '+d+'px, 0)',
                        m[c]=0,
                        m[g]=0,
