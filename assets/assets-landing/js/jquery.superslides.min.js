    ...
    t) {
        ...
        n=function(n, e) {
            this.options=t.extend( {
                play: !1, animation_speed: 600, animation_easing: "swing", animation: "slide", inherit_width_from: i, inherit_height_from: i, pagination: !0, hashchange: !1, scrollable: !0, elements: {
            ...
            var r=function() {
                ...
                s.options.hashchange&&t(i).on("hashchange",
                function() {
            ...
            c= {
                slide: function(i, t) {
                    ...
                    e.css( {
                        left: i.upcoming_position, display: "block"
                    }
                    ),
                    s.$control.animate( {
                        left: i.offset
                    ...
                    function() {
                        ...
                        n.eq(i.upcoming_slide).css( {
                            left: s.width, zIndex: 2
                        }
                        ),
                        i.outgoing_slide>=0&&n.eq(i.outgoing_slide).css( {
                            left: s.width, display: "none", zIndex: 0
                        }
                        )),
                        t()
                    }
                ...
                t) {
                    ...
                    o.css( {
                        left: this.width, opacity: 0, display: "block"
                    }
                    ).animate( {
                        opacity: 1
                    }
                    ...
                    function() {
                        ...
                        i.outgoing_slide>=0&&e.eq(i.outgoing_slide).css( {
                            opacity: 1, display: "none", zIndex: 0
                        }
                        )),
                        t()
                    }
            ...
            var d= {
                ...
                n) {
                    ...
                    e>n?o.css( {
                        height: s.height, width: s.height/n
                    }
                    ):o.css( {
                        height: s.width*n, width: s.width
                    }
                    )
                }
            }
