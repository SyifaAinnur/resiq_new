!function(t,
    ...
    e) {
        ...
        s=function(e) {
            "use strict";
            var s, r, n, a, o, h, l, g, p, d, u, c, f, v, m, x, y, C, w, b, R, S, k, M, _, H, W, T, q, I= {}, j=0;
            s=function() {
                return {
                    common: {
                    ...
                    ,
                    line: {
                        spotColor: "#f80", highlightSpotColor: "#5f5", highlightLineColor: "#f22", spotRadius: 1.5, minSpotColor: "#f80", maxSpotColor: "#f80", lineWidth: 1, normalRangeMin: void 0, normalRangeMax: void 0, normalRangeColor: "#ccc", drawNormalOnTop: !1, chartRangeMin: void 0, chartRangeMax: void 0, chartRangeMinX: void 0, chartRangeMaxX: void 0, tooltipFormat: new n('<span style="color: {{color}}">&#9679;</span> {{prefix}}{{y}}{{suffix}}')
                    }
                    ,
                    bar: {
                        barColor: "#3366cc", negBarColor: "#f44", stackedBarColor: ["#3366cc", "#dc3912", "#ff9900", "#109618", "#66aa00", "#dd4477", "#0099c6", "#990099"], zeroColor: void 0, nullColor: void 0, zeroAxis: !0, barWidth: 4, barSpacing: 1, chartRangeMax: void 0, chartRangeMin: void 0, chartRangeClip: !1, colorMap: void 0, tooltipFormat: new n('<span style="color: {{color}}">&#9679;</span> {{prefix}}{{value}}{{suffix}}')
                    }
                    ,
                    tristate: {
                        barWidth: 4, barSpacing: 1, posBarColor: "#6f6", negBarColor: "#f44", zeroBarColor: "#999", colorMap:  {}, tooltipFormat: new n('<span style="color: {{color}}">&#9679;</span> {{value:map}}'), tooltipValueLookups: {
                            map: {
                                "-1": "Loss", 0: "Draw", 1: "Win"
                            }
                        }
                    ...
                    ,
                    discrete: {
                        lineHeight: "auto", thresholdColor: void 0, thresholdValue: 0, chartRangeMax: void 0, chartRangeMin: void 0, chartRangeClip: !1, tooltipFormat: new n("{{prefix}}{{value}}{{suffix}}")
                    }
                    ,
                    bullet: {
                        targetColor: "#f33", targetWidth: 3, performanceColor: "#33f", rangeColors: ["#d3dafe", "#a8b6ff", "#7f94ff"], base: void 0, tooltipFormat: new n("{{fieldkey:fields}} - {{value}}"), tooltipValueLookups: {
                            fields: {
                                r: "Range", p: "Performance", t: "Target"
                            }
                        }
                    }
                    ,
                    pie: {
                        offset: 0, sliceColors: ["#3366cc", "#dc3912", "#ff9900", "#109618", "#66aa00", "#dd4477", "#0099c6", "#990099"], borderWidth: 0, borderColor: "#000", tooltipFormat: new n('<span style="color: {{color}}">&#9679;</span> {{value}} ({{percent.1}}%)')
                    }
                    ,
                    box: {
                        raw: !1, boxLineColor: "#000", boxFillColor: "#cdf", whiskerColor: "#000", outlierLineColor: "#333", outlierFillColor: "#fff", medianColor: "#f00", showOutliers: !0, outlierIQR: 1.5, spotRadius: 1.5, target: void 0, targetColor: "#4a2", chartRangeMax: void 0, chartRangeMin: void 0, tooltipFormat: new n("{{field:fields}}: {{value}}"), tooltipFormatFieldlistKey: "field", tooltipValueLookups: {
                            fields: {
                                lq: "Lower Quartile", med: "Median", uq: "Upper Quartile", lo: "Left Outlier", ro: "Right Outlier", lw: "Left Whisker", rw: "Right Whisker"
                            }
                        }
                    }
                }
            ...
            r=function() {
                ...
                ,
                arguments.length>1?(arguments[0]?(t.prototype=e.extend(new arguments[0],
                arguments[arguments.length-1]),
                t._super=arguments[0].prototype):t.prototype=arguments[arguments.length-1],
                arguments.length>2&&((i=Array.prototype.slice.call(arguments,
                1,
                -1)).unshift(t.prototype),
                e.extend.apply(e,
                i))):t.prototype=arguments[0],
                t.prototype.cls=t,
                t
            }
            ,
            e.SPFormatClass=n=r( {
                ...
                e) {
                    ...
                    return this.format.replace(this.fre, function() {
                        return r=arguments[1], n=arguments[3], (s=h.precre.exec(r))?(o=s[2], r=s[1]): o=!1, void 0===(a=l[r])?"": n&&i&&i[n]?i[n].get?i[n].get(a)||a: i[n][a]||a: (p(a)&&(a=e.get("numberFormatter")?e.get("numberFormatter")(a): f(a, o, e.get("numberDigitGroupCount"), e.get("numberDigitGroupSep"), e.get("numberDecimalMark"))), a)
                    }
                    )
                }
            }
            ),
            e.spformat=function(t,
            i) {
                return new n(t, i)
            }
            ,
            ...
            n) {
                var a, o;
                for(t=(!1===i?parseFloat(t).toString(): t.toFixed(i)).split(""), (a=(a=e.inArray(".", t))<0?t.length: a)<t.length&&(t[a]=n), o=a-s;
                o>0;
                o-=s)t.splice(o, 0, r);
                return t.join("")
            }
            ...
            u=function(i) {
                var e;
                t.createStyleSheet?t.createStyleSheet().cssText=i: ((e=t.createElement("style")).type="text/css", t.getElementsByTagName("head")[0].appendChild(e), e["string"==typeof t.body.style.WebkitAppearance?"innerText": "innerHTML"]=i)
            }
            ,
            e.fn.simpledraw=function(i,
            s,
            r,
            n) {
                var a, o;
                ...
                return void 0===i&&(i=e(this).innerWidth()),
                void 0===s&&(s=e(this).innerHeight()),
                a=e.fn.sparkline.canvas(i,
                s,
                this,
                n),
                (o=e(this).data("_jqs_mhandler"))&&o.registerCanvas(a),
                a
            }
            ,
            ...
            e.RangeMapClass=v=r( {
                init: function(t) {
                    var i, e, s=[];
                    for(i in t)t.hasOwnProperty(i)&&"string"==typeof i&&i.indexOf(":")>-1&&((e=i.split(":"))[0]=0===e[0].length?-1/0: parseFloat(e[0]), e[1]=0===e[1].length?1/0: parseFloat(e[1]), e[2]=t[i], s.push(e));
            ...
            m=r( {
                init: function(t, i) {
                    var s=e(t);
                    this.$el=s, this.options=i, this.currentPageX=0, this.currentPageY=0, this.el=t, this.splist=[], this.tooltip=null, this.over=!1, this.displayTooltips=!i.get("disableTooltips"), this.highlightEnabled=!i.get("disableHighlight")
                }
                ,
                ...
                registerCanvas:function(t) {
                    var i=e(t.canvas);
                    this.canvas=t, this.$canvas=i, i.mouseenter(e.proxy(this.mouseenter, this)), i.mouseleave(e.proxy(this.mouseleave, this)), i.click(e.proxy(this.mouseclick, this))
                }
                ,
                reset:function(t) {
                ...
                mouseenter:function(i) {
                    e(t.body).unbind("mousemove.jqs"), e(t.body).bind("mousemove.jqs", e.proxy(this.mousemove, this)), this.over=!0, this.currentPageX=i.pageX, this.currentPageY=i.pageY, this.currentEl=i.target, !this.tooltip&&this.displayTooltips&&(this.tooltip=new x(this.options), this.tooltip.updatePosition(i.pageX, i.pageY)), this.updateDisplay()
                }
                ,
                mouseleave:function() {
                    e(t.body).unbind("mousemove.jqs");
                    var i, s=this.splist, r=s.length, n=!1;
                    for(this.over=!1, this.currentEl=null, this.tooltip&&(this.tooltip.remove(), this.tooltip=null), i=0;
                    i<r;
                    i++)s[i].clearRegionHighlight()&&(n=!0);
                ...
                updateDisplay:function() {
                    ...
                    if(this.over) {
                        for(i=0;
                        i<a;
                        i++)(s=n[i].setRegionHighlight(this.currentEl, l, g))&&(o=!0);
                        if(o) {
                            if((r=e.Event("sparklineRegionChange")).sparklines=this.splist, this.$el.trigger(r), this.tooltip) {
                                for(t="", i=0;
                                i<a;
                                i++)t+=n[i].getCurrentRegionTooltip();
            ...
            x=r( {
                sizeStyle: "position: static !important;display: block !important;visibility: hidden !important;float: left !important;", init: function(i) {
                    var s, r=i.get("tooltipClassname", "jqstooltip"), n=this.sizeStyle;
                    this.container=i.get("tooltipContainer")||t.body, this.tooltipOffsetX=i.get("tooltipOffsetX", 10), this.tooltipOffsetY=i.get("tooltipOffsetY", 12), e("#jqssizetip").remove(), e("#jqstooltip").remove(), this.sizetip=e("<div/>", {
                        id: "jqssizetip", style: n, class: r
                    }
                    ),
                    this.tooltip=e("<div/>",
                    {
                        id: "jqstooltip", class: r
                    }
                    ...
                    e(window).bind("resize.jqs scroll.jqs",
                    e.proxy(this.updateWindowDims,
                    this)),
                ...
                setContent:function(t) {
                    ...
                    this.getSize(t), this.tooltip.html(t).css( {
                        width: this.width, height: this.height, visibility: "visible"
                    }
                    ),
                ...
                i) {
                    ...
                    else this.mousex=t-=this.offsetLeft,
                ...
                ,
                remove:function() {
                    this.tooltip.remove(), this.sizetip.remove(), this.sizetip=this.tooltip=void 0, e(window).unbind("resize.jqs scroll.jqs")
                }
            }
            ),
            e(function() {
            ...
            ,
            e.fn.sparkline.defaults=s(),
            e.sparkline_display_visible=function() {
                var t, i, s, r=[];
                for(i=0, s=q.length;
                i<s;
                i++)t=q[i][0], e(t).is(":visible")&&!e(t).parents().is(":hidden")?(q[i][1].call(t), e.data(q[i][0], "_jqs_pending", !1), r.push(i)): e(t).closest("html").length||e.data(t, "_jqs_pending")||(e.data(q[i][0], "_jqs_pending", !1), r.push(i));
                for(i=r.length;
                i;
                i--)q.splice(r[i-1], 1)
            }
            ...
            e.fn.sparkline.options=r( {
                init: function(t, i) {
                    var s, r, n, a;
                    this.userOptions=i=i|| {}, this.tag=t, this.tagValCache= {}, n=(r=e.fn.sparkline.defaults).common, this.tagOptionsPrefix=i.enableTagOptions&&(i.tagOptionsPrefix||n.tagOptionsPrefix), s=(a=this.getTagSetting("type"))===I?r[i.type||n.type]: r[a], this.mergedOptions=e.extend( {}, n, s, i)
                }
                ,
                getTagSetting:function(t) {
                    var i, e, s, r, n=this.tagOptionsPrefix;
                    if(!1===n||void 0===n)return I;
                    if(this.tagValCache.hasOwnProperty(t))i=this.tagValCache.key;
                    else {
                        if(null==(i=this.tag.getAttribute(n+t)))i=I;
                        else if("["===i.substr(0, 1))for(e=(i=i.substr(1, i.length-2).split(",")).length;
                        e--;
                        )i[e]=h(i[e].replace(/(^\s*)|(\s*$)/g, ""));
                        else if("{"===i.substr(0, 1))for(s=i.substr(1, i.length-2).split(","), i= {}, e=s.length;
                        e--;
                        )i[(r=s[e].split(":", 2))[0].replace(/(^\s*)|(\s*$)/g, "")]=h(r[1].replace(/(^\s*)|(\s*$)/g, ""));
                        else i=h(i);
                ...
                i) {
                    ...
                    return s!==I?s: void 0===(e=this.mergedOptions[t])?i: e
                }
            }
            ),
            e.fn.sparkline._base=r( {
                disabled: !1, init: function(t, i, s, r, n) {
                    this.el=t, this.$el=e(t), this.values=i, this.options=s, this.width=r, this.height=n, this.currentRegion=void 0
                }
                ,
                initTarget:function() {
                ...
                i) {},
                setRegionHighlight:function(t,
                i,
                e) {
                    var s, r=this.currentRegion, n=!this.options.get("disableHighlight");
                    return i>this.canvasWidth||e>this.canvasHeight||i<0||e<0?null: r!==(s=this.getRegion(t, i, e))&&(void 0!==r&&n&&this.removeHighlight(), this.currentRegion=s, void 0!==s&&n&&this.renderHighlight(), !0)
                }
                ,
